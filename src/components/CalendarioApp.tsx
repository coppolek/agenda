          ...
          <div className="bg-white rounded-3xl p-6 md:p-8 w-full max-w-md shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-end gap-3">
              <button 
                ...
                className="w-full sm:w-auto px-5 py-2.5 rounded-full text-sm font-semibold text-slate-600 hover:bg-slate-100 transition-colors order-2 sm:order-1"
              >
                Annulla
              </button>
              <button 
                ...
                className="w-full sm:w-auto bg-[#5B60F6] hover:bg-[#4A4FD1] disabled:opacity-50 text-white px-5 py-2.5 rounded-full text-sm font-semibold flex items-center justify-center gap-2 transition-colors shadow-sm order-1 sm:order-2"
              >
                <Download size={16} />
                Scarica PDF
              </button>
